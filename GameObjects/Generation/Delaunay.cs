...
namespace Triangulator
{
    ...
    public class Delaunay
    {
        ...
        public List<Microsoft.Xna.Framework.Vector3> DoEdges(List<Microsoft.Xna.Framework.Point> rooms)
        {
            List<Geometry.Point> pts = new List<Geometry.Point>();
            foreach(Microsoft.Xna.Framework.Point p in rooms)
            {
